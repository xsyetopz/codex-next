...
class CollabAgentToolCallThreadItem(BaseModel):
    ...
    resolved_model: Annotated[
        str | None,
        Field(
            alias="resolvedModel",
            description="Model resolved for the recipient after role and runtime defaults apply.",
        ),
    ] = None
    resolved_reasoning_effort: Annotated[
        ReasoningEffort | None,
        Field(
            alias="resolvedReasoningEffort",
            description="Reasoning effort resolved for the recipient after role and runtime defaults apply.",
        ),
    ] = None
